    ...
    <main className="flex min-h-screen bg-white md:ml-[25%]">
      ...
      <div className="w-1/1 p-8">
        ...
        <section className="mb-8">
          <h2 className="mb-4">発表論文・学会（すべて査読あり）</h2>
        ...
        <section className="mb-8">
          ...
          <ol className="list-decimal list-inside space-y-4">
            ...
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2021.9 – present</div>
              <div className="col-span-4">
                <p className="font-bold">自由エネルギー原理を基にした力覚的な人-ロボットの相互作用研究</p>
                <p>谷淳 教授 / 沖縄、日本</p>
                <p className="mt-1">沖縄科学技術大学院大学 認知脳ロボティクス研究ユニット</p>
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>自由エネルギー原理に基づき、予測符号化的な変分RNNを用いてヒューマノイドロボットとの身体的な相互作用をモデル化。</li>
                  <li>人間とロボット間の双方向の感覚運動ダイナミクスを探究し、相互適応的な運動行動の発現を理論モデル [1] および段階的学習 [2] の両面で実証。</li>
                </ul>
              </div>
            </li>

            {/* 3. 沖縄科学技術大学院大学 神経計算ユニット */}
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2021.5 – 2021.9</div>
              <div className="col-span-4">
                <p className="font-bold">転移学習を用いた、スマートフォンロボット同士がお互いを認識する画像認識モデルの構築</p>
                <p>銅谷賢治 教授 / 沖縄、日本</p>
                <p className="mt-1">沖縄科学技術大学院大学 神経計算ユニット</p>
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>TensorflowのCNNモデルの転移学習を行うことで、スマートフォンロボット同士がお互いを認識できる画像認識モデルを構築。</li>
                </ul>
              </div>
            </li>
            ...
            <li className="grid grid-cols-5 gap-2">
              ...
              <div className="col-span-4">
                <p className="font-bold">ファンデルワールス化合物CeTe3及びCeTe2Seにおける磁気特性評価</p>
                <p>岡田佳憲 准教授 / 沖縄、日本</p>
                <p className="mt-1">沖縄科学技術大学院大学 量子物質化学ユニット</p>
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>藤澤博士と今井博士と共に、ファンデルワールス層状化合物CeTe3及びCeTe2Seの磁気特性を評価。</li>
                  <li>研究成果は論文として発表済み [4]。</li>
                </ul>
              </div>
            </li>
            ...
            {/* 5. 慶應義塾大学 的場・神原研究室 */}
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2019.4 – 2020.3</div>
              <div className="col-span-4">
                <p className="font-bold">Cu欠陥による複合アニオン層状化合物 LaCu1−δS0.5Se0.5O の熱電変換効率最適化に向けた試料合成</p>
                <p>的場正憲 教授 / 神奈川、日本</p>
                <p className="mt-1">慶應義塾大学 的場・神原研究室</p>
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>高い熱電変換効率が期待されるLaCu1−δS0.5Se0.5の多結晶体合成に初めて成功。</li>
                  <li>LaCu1−δS0.5Se0.5多結晶体におけるCu欠陥の熱電変換特性への影響を評価。研究成果は論文として発表済み [5, 6]。</li>
                </ul>
              </div>
            </li>
          </ol>
        ...
        <section className="mb-8 mt-12">
          <h2 className="mb-4">職歴</h2>
          <ol className="list-decimal list-inside space-y-4">
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2023.9 – present</div>
              <div className="col-span-4">
                <p className="font-bold">大規模生成モデルと自然言語処理モデルを統合した自動議事録送付システムの開発・運用</p>
                <p>東京、日本</p>
                <p className="mt-1">株式会社レアゾン・ホールディングス、R&D開発本部 エンジニア</p>
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>正社員（週４日勤務）として勤務中。</li>
                  <li>LLMとNLPを統合した自動議事録送付システムをメインエンジニアとして開発（コードの95%以上を担当）。現在は社内で稼働中。</li>
                  <li>AWS EC2, S3, SageMaker, Lambdaなどを活用し、非同期推論によるスケーラブルな構成を構築。</li>
                  <li>RAGを活用したGPTエージェントを開発し、社内規則に関する自然言語問い合わせに対応。</li>
                </ul>
              </div>
            </li>
          </ol>
        ...
        {/* --- 奨学金 & フェローシップ --- */}
        <section className="mb-8 mt-12">
          <h2 className="mb-4">奨学金 & フェローシップ</h2>
          <ol className="list-decimal list-inside space-y-4">
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2020.9 – present</div>
              <div className="col-span-4">
                <p className="font-bold">沖縄科学技術大学院大学 博士奨学生</p>
                <p>沖縄、日本</p>
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>年間240万円の奨学金を5年間給付される博士奨学生に採択。</li>
                </ul>
              </div>
            </li>
            <li className="grid grid-cols-5 gap-2">
              ...
              <div className="col-span-4">
                <p className="font-bold">JEES・ソフトバンクAI人材育成奨学金</p>
                <p>ソフトバンク、日本</p>
                <ul className="list-disc list-inside mt-1 space-y-1">
        ...
        {/* --- 学術活動 --- */}
        <section className="mb-8 mt-12">
          <h2 className="mb-4">学術活動</h2>
          <ol className="list-decimal list-inside space-y-4">
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2025.5</div>
              <div className="col-span-4">
                <p className="font-bold">IEEE ICDL 2025 Contributed Papers 査読者</p>
                <p>
