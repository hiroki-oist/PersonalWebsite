  ...
  return (
    <main className="flex min-h-screen bg-white md:ml-[25%]">
      ...
      <div className="w-1/1 p-8">
        <h1 className="text-4xl mb-6">Achievements</h1>

        {/* --- Publications --- */}
        <section className="mb-8">
          <h2 className="mb-4">Publications (All Peer-Reviewed)</h2>
          <ol className="list-decimal list-inside space-y-2">
            <li>
              ...
              <p className="ml-6 mt-1 text-gray-600">
                Modeled physical human-robot kinaesthetic interaction using a predictive-coding-inspired
                variational RNN (PV-RNN) based on the Free Energy Principle.
                Quantitatively analyzed how the hyperparameter balancing prediction accuracy and model
                complexity affects human-robot force interaction.
            ...
            <li>
              ...
              <p className="ml-6 mt-1 text-gray-600">
                ...
                Principal component analysis on the internal state space clarified how incremental learning
                reshapes the distribution of learned motion patterns.
            ...
            <li>
              ...
              <p className="ml-6 mt-1 text-gray-600">
                ...
                Demonstrated stable reproduction of 26 handwritten alphabet trajectories and confidence
                estimation using the Reachy humanoid robot (Pollen Robotics) in both simulation and real-world settings.
              </p>
            </li>
            ...
            <li>
              ...
              {/* <p className="ml-6 mt-1 text-gray-600">
                ...
                Revealed that the unusual alignment of magnetic moments along the hard axis in CeTe₂Se
                originates from competition between antisymmetric spin-orbit coupling and crystal electric field anisotropy.
              </p> */}
            </li>

            <li>
              Azuma Nobuhiko, <span className="font-bold underline">Hiroki Sawada</span>, Itoh Houji, Sakagami Ryosuke,
              Matoba Masanori, Usui Hidenori, and Kamihara Yoichi. (2021).
              <br />
              <em>
                <Link
            ...
            <li>
              N. Azuma, <span className="font-bold underline">H. Sawada</span>, H. Ito, R. Sakagami, Y. Tanaka,
              T. Fujioka, M. Matoba, and Y. Kamihara. (2024).
              <br />
              <em>
                <Link
              ...
              {/* <p className="ml-6 mt-1 text-gray-600">
                ...
                demonstrated that Cu vacancies reduce resistivity but lead to a low figure of merit (ZT ≈ 6.4×10⁻⁴)
                due to a small Seebeck coefficient. We also confirmed Debye-like phonon behavior in its thermal conductivity.
              </p> */}
            </li>
          </ol>
        </section>
        ...
        {/* --- Research History --- */}
        <section className="mb-8">
          <h2 className="mb-4">Research History</h2>
          <ol className="list-decimal list-inside space-y-4">
            ...
            {/* 2. OIST - Human-Robot Interaction */}
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">
                2021.9 – present
              </div>
            ...
            <li className="grid grid-cols-5 gap-2">
              ...
              <div className="col-span-4">
                ...
                <p>
                  Assoc. Prof. Yoshinori Okada / Okinawa, Japan
                </p>
                <p className="mt-1">
            ...
            <li className="grid grid-cols-5 gap-2">
              ...
              <div className="col-span-4">
                ...
                <p>
                  Prof. Masanori Matoba / Kanagawa, Japan
                </p>
                <p className="mt-1">
        ...
        <section className="mb-8 mt-12">
          ...
          <ol className="list-decimal list-inside space-y-4">
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2023.9 – present</div>
              <div className="col-span-4">
                <p className="font-bold">
                  Development and Operation of an Automated Meeting Minutes Delivery System Integrating LLM and NLP
                </p>
                <p>Tokyo, Japan</p>
                <p className="mt-1">R&D Engineer, Reazon Holdings Corporation</p>
                <ul className="list-disc list-inside mt-1 space-y-1">
        ...
        <section className="mb-8 mt-12">
          ...
          <ol className="list-decimal list-inside space-y-4">
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2016.4 – 2020.3</div>
              <div className="col-span-4">
                <p className="font-bold">Keio University</p>
                <p>B.S. in Applied Physics and Informatics</p>
                <p>Kanagawa, Japan</p>
              </div>
            </li>
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2020.9 – present</div>
              <div className="col-span-4">
                <p className="font-bold">Okinawa Institute of Science and Technology</p>
                <p>Ph.D. in Cognitive Neurorobotics (expected completion: Feb. 2026)</p>
                <p>Okinawa, Japan</p>
              </div>
            </li>
          </ol>
        ...
        <section className="mb-8 mt-12">
          <h2 className="mb-4">Scholarships and Fellowships</h2>
          <ol className="list-decimal list-inside space-y-4">
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2020.9 – present</div>
              <div className="col-span-4">
                <p className="font-bold">OIST Ph.D. Fellowship</p>
                <p>Okinawa, Japan</p>
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>Selected as a Ph.D. fellow receiving 2.4 million JPY annually for five years.</li>
                </ul>
              </div>
            </li>
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2021.4 – 2022.3</div>
              <div className="col-span-4">
                <p className="font-bold">JEES & SoftBank AI Human Resource Development Scholarship</p>
                <p>SoftBank, Japan</p>
                <ul className="list-disc list-inside mt-1 space-y-1">
            ...
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2025.1 – 2025.7</div>
              <div className="col-span-4">
        ...
        {/* --- Academic Services --- */}
        <section className="mb-8 mt-12">
          <h2 className="mb-4">Academic Services</h2>
          <ol className="list-decimal list-inside space-y-4">
            <li className="grid grid-cols-5 gap-2">
              <div className="col-span-1 text-gray-600">2025.5</div>
              <div className="col-span-4">
                <p className="font-bold">Reviewer, IEEE ICDL 2025 Contributed Papers</p>
                <p>
                  Reviewed full papers in the fields of cognitive robotics and learning for the IEEE
