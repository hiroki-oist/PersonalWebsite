        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-20 md:px-10 lg:px-14">
          <div className="max-w-4xl">
            ...
            <p className="mt-8 max-w-3xl text-base leading-8 text-[#4C4540] md:text-lg">
              For research inquiries, collaborations, talks, or related contact,
              please use the email addresses or profiles listed below.
            </p>
          </div>
        </div>
      </section>
...
function ContactOverview() {
  const items = [
    ...
    {
      value: "GitHub",
      label: "Code and development projects",
    },
    {
      value: "X",
  ...
  return (
    ...
    >
      ...
      <p className="mt-6 text-sm font-semibold text-[#B86524]">
        {item.href.startsWith("mailto:") ? "Send email" : "Open profile"}
